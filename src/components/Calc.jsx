...
export default function Calc() {
  ...
  const sunriseDate = new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), solarTimes.sunrise.getHours(), solarTimes.sunrise.getMinutes(), solarTimes.sunrise.getSeconds());

  const sunsetDate = new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), solarTimes.sunset.getHours(), solarTimes.sunset.getMinutes(), solarTimes.sunset.getSeconds());
